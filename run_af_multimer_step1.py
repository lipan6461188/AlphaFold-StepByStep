...
parser = argparse.ArgumentParser(description='AlphaFold-Multimer Step 1 -- Search homologous sequences and templates')
...
uniprot_database_path       = check_file(ini_config['DATABASE']['uniprot_database_path'])
pdb_seqres_database_path    = check_file(ini_config['DATABASE']['pdb_seqres_database_path'])
